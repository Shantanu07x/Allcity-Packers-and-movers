...
<head>
  ...
  if (!@$img) $img = base_url('') . "assets/images/logo/allfab.png";
 ...
 ?>
  ...
  <link rel="apple-touch-icon" href="<?= base_url('assets/images/logo/allfab.png')?>">
  <link rel="shortcut icon" href="<?= base_url('assets/images/logo/allfab.png')?>">
  <link rel="apple-touch-icon" href="<?= base_url('assets/images/logo/allfab.png')?>">
  ...
  <script type="application/ld+json">
    {
      ...
      "name": "<?= $company3?>",
      "url": "<?= @$url?>",
      "logo": "<?= base_url()?>assets/images/logo/allfab.png"
    }
  </script>
  <script type="application/ld+json">
    {
      ...
      "name": "<?= $company3?>",
      "url": "<?= @$url?>",
      "image": ["<?= base_url()?>assets/images/logo/allfab.png"],
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "  
        <?=$address1?>",
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  <link rel="stylesheet" href="<?=base_url("assets/css/responsive.css?v=1.6")?>">
</head>
<body>
