...
<head>
    ...
    <link rel="icon" type="image/png" href="<?=base_url()?>assets/images/logo/citylogoo.webp">
    ...
    <div id="hoeapp-wrapper" class="hoe-hide-lpanel" hoe-device-type="desktop" class="view-animate">
        <header id="hoe-header" hoe-lpanel-effect="default">
            <div class="hoe-left-header">
                <a href="#">
                    <img id="logo1a" src="<?= base_url() ?>assets/images/logo/citylogoo.webp" style="display:inline-block;height: 45px;">
                    <span></span>
                </a>
            </div>
