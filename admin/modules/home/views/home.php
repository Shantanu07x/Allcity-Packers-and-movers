  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 position-relative mb-4 mb-lg-0">
        <img src="<?= base_url("assets/images/service/allcity4.jpeg") ?>" class=" main-img w-100" alt="packers"
          loading="lazy">
        <img src="<?= base_url("assets/images/service/allcity6.jpeg") ?>" class="small-img shadow d-none d-md-block"
          alt="worker" loading="lazy">
      </div>
      <div class="col-lg-6">
        <span class="text-danger fw-semibold">About Us</span><br>
...
<section class="py-5 home-packing-gallery-section">
  <div class="container">
    <div class="home-packing-gallery-head text-center mx-auto">
      <span class="home-packing-gallery-eyebrow">Work Gallery</span>
