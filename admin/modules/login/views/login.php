...
<head>
    ...
    <title>All City Movers Packers <?=date("D d M Y")?></title>
    
    <link href="<?=base_url()?>assets/admin/css/main.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="<?=base_url()?>assets/images/logo/allfab.png"/>
</head>
...
<br><br><br><br>            
    <div class=" col-sm-4 col-sm-offset-4 text-center">
        ...
        <br>
        <img src="<?=base_url("assets/images/logo/citylogoo.webp")?>" class="img-show" style="width:150px;" alt="logo">
        <br><br><br>
