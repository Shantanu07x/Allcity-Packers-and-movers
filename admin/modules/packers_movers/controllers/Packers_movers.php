...
class Packers_movers extends MX_Controller
{
    ...
    function get_title($city, $state)
    {
        ...
        $seo = array(
            "Zirakpur" => array(
                'title' => "Packers And movers in $city -.Moving N Packing Expert 9876392657",
                "desc" => "Looking packers N movers in $city? All City Movers Packers offers safe, affordable & professional Moving services in $city with Moving Expert."
            ),
            "Mohali" => array(
                'title' => "Packers And movers in $city -.Moving N Packing Expert 9876392657",
                "desc" => "Looking packers N movers in $city? All City Movers Packers offers safe, affordable & professional Moving services in $city with Moving Expert."
        ...
        //edit by Mr.Rajput 
        return array(
            'title' => "Best Packers movers in $city | Packing N Moving 9876392657",
            "desc" => "Looking packers & movers in $city? All City Movers Packers offers safe, affordable & professional Moving services in $city with Moving Expert."
        );
    }
