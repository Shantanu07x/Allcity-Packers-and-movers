          ...
          <div class="social-panel trust-action-panel h-100">
            ...
            <div class="row g-3 text-center action-tile-grid">
              <div class="col-6">
                <a href="https://www.youtube.com/yourchannel" target="_blank" rel="noopener"
                  ...
                  <span class="action-icon-wrap">
                    <img src="<?php echo base_url('assets/images/youtube-icon.png'); ?>" width="78" height="78"
                      alt="Youtube-image-channel view"
                      onerror="this.src='https://cdn-icons-png.flaticon.com/512/1384/1384060.png'">
                  </span>
              ...
              <div class="col-6 social-gal">
                <a href="<?php echo site_url('photo-gallery'); ?>" class="social-action-card gallery-card">
                  <span class="action-icon-wrap">
                    <img src="<?php echo base_url('assets/images/gallery-icon.png'); ?>" width="78" height="78"
                      alt="gallery-visit" onerror="this.src='https://cdn-icons-png.flaticon.com/512/3342/3342137.png'">
                  </span>
              ...
              <div class="col-6">
                <a href="tel:+919876392657" class="social-action-card call-card">
                  <span class="action-icon-wrap">
                    <img src="<?php echo base_url('assets/images/call-icon.png'); ?>" width="78" height="78"
                      alt="contact number" onerror="this.src='https://cdn-icons-png.flaticon.com/512/724/724664.png'">
                  </span>
                  <span>Call Now</span>
              ...
              <div class="col-6">
                <a href="https://wa.me/919876392657" target="_blank" rel="noopener"
                  class="social-action-card whatsapp-card">
                  <span class="action-icon-wrap">
                    <img src="<?php echo base_url('assets/images/whatsapp-icon.png'); ?>" width="78" height="78"
                      alt="WhatsApp Contact" onerror="this.src='https://cdn-icons-png.flaticon.com/512/733/733585.png'">
                  </span>
                  <span>WhatsApp</span>
      ...
      <div class="row g-4 mb-4 align-items-center">
        ...
        <div class="col-lg-6 col-md-6 col-12 white-bg-form">
          <div class="image-box text-center">
            <img src="<?= base_url("assets/images/service/pic3.jpg") ?>" alt="city image" class="img-fluid"
              loading="lazy">
          </div>
        </div>
      </div>
              ...
              <div class="card h-100 border-0 shadow rounded-4 overflow-hidden review-card" itemprop="review" itemscope
                ...
                <div class="card-header py-3 border-0 review-card-header">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge fw-bold px-3 py-2 review-rating-badge" itemprop="reviewRating" itemscope
        ...
        <section class="city-guides-panel h-100">
          <div class="city-section-head">
            <div>
              ...
              <h2 class="city-section-title">Tips &amp; Guides</h2>
            </div>
