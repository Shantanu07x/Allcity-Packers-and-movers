                        ...
                        <div class="blog-single-content">
                            ...
                            <div class="blog-thumb-img">
                                <?php if (@$query[0]->image && file_exists(FCPATH . 'assets/uploads/blog/' . @$query[0]->image)): ?>
                                    <img src="<?= base_url('assets/uploads/blog/' . @$query[0]->image) ?>"
                                        alt="<?= @$query[0]->title ?>">
                                <?php else: ?>
                            ...
                            <div class="blog-info">
                                <div class="blog-meta">
                                    <div class="blog-meta-left">
                                        <ul>
                                            <li><i class="fa-solid fa-calendar-days"></i><?= @$query[0]->timestamp ?>
                                            </li>
                                    ...
                                    <div class="blog-meta-right">
                                        <a href="javascript:void(0);" class="share-link" data-bs-toggle="modal"
                                            data-bs-target="#shareModal"><i class="far fa-share-alt"></i> Share</a>
                                    </div>
                                                ...
                                                <div class="modal-body row">
                                                    <div class="social-buttons">
                                                        <a href="https://www.facebook.com/sharer/sharer.php?u=YOUR_URL"
                                                            target="_blank"
                                                            class="social-btn facebook btn btn-primary w-100 mb-2">
                                                            <i class="fab fa-facebook-f"></i> Facebook
                                                        </a>
                                                        <a href="https://twitter.com/intent/tweet?url=YOUR_URL"
                                                            target="_blank"
                                                            class="social-btn twitter btn btn-info w-100 mb-2">
                                                            <i class="fab fa-twitter"></i> Twitter
                                                        </a>
                                                        <a href="https://api.whatsapp.com/send?text=YOUR_URL"
                                                            target="_blank"
                                                            class="social-btn whatsapp btn btn-success w-100 mb-2">
                                ...
                                <div class="blog-details">
                                    <p class="mb-10"><?= @$query[0]->description ?></p>
                ...
                <div class="col-lg-4 pt-5">
                    <aside class="blog-sidebar">
                                    ...
                                    <div class="recent-post-item">
                                        ...
                                        <div class="recent-post-info">
                                            ...
                                            <span><i class="far fa-clock"></i>
                                                <?php echo date('M d, Y', strtotime($post['timestamp'])); ?></span>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                        ...
                        <div class="widget social">
                            ...
                            <div class="social-link text-white">
                                <a href="<?= $facebookhtml ?>" target="_blank"><i class="bi bi-facebook"></i></a>
                                <a href="<?= $twitterhtml ?>" target="_blank"><i class="bi bi-twitter-x"></i>
                                </a>
                                <a href="<?= $instagramhtml ?>" target="_blank"><i class="bi bi-instagram"></i>

                                    <a href="<?= $youtubehtml ?>" target="_blank"><i class="bi bi-youtube"></i>
                                    </a>
                            </div>
                        </div>
                    </aside>
