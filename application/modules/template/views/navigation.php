...
<div class="fullscreen-menu overflow-y-scroll overflow-md-y-hidden" id="fullscreenMenu">
    ...
    <div class="menu-content">
        ...
        <div>
            ...
            <div class="menu-section">
                ...
                <div class="social-icons d-flex gap-3 mt-3">
                    <a href="<?= $facebookhtml ?>" class="d-flex align-items-center justify-content-center rounded-circle" target="_blank">
                        <i class="bi bi-facebook"></i>
                    </a>
                    <a href="<?= $youtubehtml ?>" class="d-flex align-items-center justify-content-center rounded-circle" target="_blank">
                        <i class="bi bi-youtube"></i>
                    </a>
                    <!-- <a href="<?= $linkedinhtml ?>" class="d-flex align-items-center justify-content-center rounded-circle">
                        <i class="bi bi-linkedin"></i>
                    </a> -->
                    <a href="<?= $instagramhtml ?>" class="d-flex align-items-center justify-content-center rounded-circle " target="_blank">
        ...
        <div class="menu-section">
            ...
            <ul class="list-unstyled">
                <!-- <li class="mb-2"><a href="<?= site_url('') ?>"><i class="bi bi-lightbulb-fill me-2 text-primary"></i>Moving Tips And Suggestion</a></li> -->
