      ...
      <div class="col-lg-6">
        <div class="row">
          <div class="col-md-6">
            ...
            <ul class="list-unstyled footer-links small">
              ...
              <li><a href="<?= site_url('office-shifting') ?>"><i class="bi bi-chevron-right me-2"></i>Office Shifting</a></li>
              <li><a href="<?= site_url('packing-unpacking') ?>"><i class="bi bi-chevron-right me-2"></i>Packing And Unpacking</a></li>
              <li><a href="<?= site_url('vehicle-shifting') ?>"><i class="bi bi-chevron-right me-2"></i>Vehicle shifting</a></li>
              <li><a href="<?= site_url('storage-service') ?>"><i class="bi bi-chevron-right me-2"></i>Storage service</a></li>
              <li><a href="<?= site_url('transportation-service') ?>"><i class="bi bi-chevron-right me-2"></i>Transportation Service</a></li>
              ...
              <li><a href="<?= site_url('cargo-service') ?>"><i class="bi bi-chevron-right me-2"></i>Cargo service</a></li>
                <li><a href="<?= site_url('our-branches') ?>"><i class="bi bi-chevron-right me-2"></i>Our-Branches</a></li>
            </ul>
          </div> 
          <div class="col-md-6">
            ...
            <ul class="list-unstyled footer-links small">
              ...
              <li><a href="<?= site_url('blog') ?>"><i class="bi bi-chevron-right me-2"></i>Blogs</a></li>
        ...
        <div class="col-lg-6 text-lg-end">
          ...
          <div class="d-flex gap-2 justify-content-lg-end mb-3">
            <a href="<?= $facebookhtml ?>" class="social-icon" aria-label="Facebook " target="_blank">
              <i class="bi bi-facebook"></i>
              <span class="visually-hidden">Facebook</span>
            </a>
            <a href="<?= $twitterhtml ?>" class="social-icon" aria-label="Twitter " target="_blank">
              <i class="bi bi-twitter"></i>
              <span class="visually-hidden">Twitter</span>
            </a>
            <a href="<?= $youtubehtml ?>" class="social-icon" aria-label="YouTube" target="_blank">
              <i class="bi bi-youtube"></i>
              <span class="visually-hidden">YouTube</span>
            </a>
            <a href="<?= $instagramhtml ?>" class="social-icon" aria-label="Instagram" target="_blank">
