...
<div class="our-service-page feature-content-section acx-inline-038">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 offset-sm-3 mb-4 text-left wow fadeInUp">
                    ...
                    <button type="button" class="btn float-left btn-xs acx-inline-039" data-toggle="modal" data-target="#rvwmdl">Write a Review <i class="fas fa-pen"></i></button>
                </div>
            </div>
            <div class="row">
                <?php
                                ...
                                <div class="content-text">
                                    <span class="float-left">
                                        <strong itemprop="author" itemscope itemtype="https://schema.org/Person">
                                            <span itemprop="name" class="acx-inline-040"><?= $r->name ?></span>
                                        </strong>
                                    </span>
                                    <span class="acx-inline-041">
                                        <span>
                                            <?php for ($i = 0; $i < $r->stars; $i++) { ?>
                                                <i class="text-warning fa fa-star"></i>
                                            <?php } ?>
                                        </span>
                                        <span class="float-right star-saver blink mr-2 acx-inline-042">
                                    ...
                                    <br>
                                    <h4 class="acx-inline-043">
                                        <q itemprop="name"><?= $r->r_title ?></q>
                                    </h4>
                                    <p class="acx-inline-042"><?= mb_strimwidth($r->r_desc, 0, 150, "..."); ?></p>
                                    <p class="acx-inline-042">
                                        <small class="acx-inline-044"><?= $em ?></small>
                                        <small class="float-right acx-inline-045" itemprop="datePublished" content="<?= $pdate ?>"><?= $r->posted_date ?></small>
                                    </p>
                                    <?php if (@$r->r_img) { ?>
                                    ...
                                    <?php } ?>
                                    <div class="acx-inline-046">
                                        <b class="acx-inline-047"> Reply from <?= $company3 ?></b><br>
                                        <?php
                                        if ($r->stars == "5") {
                                        ...
                                        ?>
                                        <p class='acx-inline-048'><?= @$reply ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
